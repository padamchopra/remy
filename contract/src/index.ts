...
export const organizationWorkspaceSchema = z.object({ icon: z.string().optional(), tint: z.string().optional(), id: z.string().min(1), organizationId: z.string().min(1), name: z.string().min(1), origin: z.string().min(1), restricted: z.boolean(), createdAt: z.number().int(), updatedAt: z.number().int(), access: workspaceAccessSchema.optional() });
