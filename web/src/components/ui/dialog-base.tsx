...
/// Base UI's dialog, for new surfaces and redesigns. `ui/dialog.tsx` is the
/// Radix one the rest of the app still uses; both may be open at once.
...
function DialogBackdrop({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Backdrop>) {
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/65 transition-opacity duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className
      )}
      {...props}
    />
