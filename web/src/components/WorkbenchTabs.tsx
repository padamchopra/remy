...
/// Size the list to its tabs so Add stays beside the last one; shrink and
/// scroll the list when the strip runs out of room.
export const tabListClass = "h-auto min-w-0 w-auto flex-initial justify-start gap-0.5 overflow-x-auto overflow-y-hidden rounded-none bg-transparent p-0 scrollbar-none";
